...
class Auth extends Component {
  ...
  _checkLogin = async ({ username, password }) => {
    ...
    if (res_login.require === false) {
      ...
      try {
        ...
        localStorage.setItem("company_table_uuid", res_login.data[0].company_table_uuid);
  ...
  _handleLogin = (data) =>
    ...
    this.setState({ authcertifying: true }, () => this._checkLogin(data));
